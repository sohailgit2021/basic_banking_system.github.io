...
<div id="container">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to The Sparks Foundation
                        Bank!</b></p>
            </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 class="text-warning" style="text-shadow:2px 2px 2px gray; color:white; text-transform: uppercase;"><b>Our Awesome Facilities</b></h1>
