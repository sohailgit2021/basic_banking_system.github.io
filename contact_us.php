...
<body style="background-color:#212529; background-image:url('statics/5570834-min.jpg'); padding-top:8%;">
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            <div
                ...
                <h1 class="text-warning" style=" color:white; text-transform: uppercase;">Contact Us</h1>
            </div>
